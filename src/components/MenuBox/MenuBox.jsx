...
import techspaceImage from "./../../assets/images/techspace.png";
const MenuBox = (props) => {
    ...
    <nav className="menu-box">
      <div className="menu__item menu__item1">
        <div className="menu__item-inner">
          ...
          <div className="menu__bg__container">

            <div className="menu__bg__line"></div>
            <div className="menu__bg__content">
          ...
          <div className="menu__bg__bottom">
